 ...
 * and due to final consts reduce number of string creation
 */
public class SDODataTypes {
    ...
    public static final Type DECIMAL = TYPE_HELPER.getType("commonj.sdo", "Decimal");
    public static final String DECIMAL_STR = "commonj.sdo.Decimal";
    ...
    public static final Type DURATION = TYPE_HELPER.getType("commonj.sdo", "Duration");
    public static final String DURATION_STR = "commonj.sdo.Duration";
    ...
    public static final Type INTOBJECT = TYPE_HELPER.getType("commonj.sdo", "IntObject");
    public static final String INTOBJECT_STR = "commonj.sdo.IntObject";
    ...
    public static final Type MONTH = TYPE_HELPER.getType("commonj.sdo", "Month");
    public static final String MONTH_STR = "commonj.sdo.Month";
    
    public static final Type MONTHDAY = TYPE_HELPER.getType("commonj.sdo", "MonthDay");
    public static final String MONTHDAY_STR = "commonj.sdo.MonthDay";
    ...
    public static final Type STRINGS = TYPE_HELPER.getType("commonj.sdo", "Strings");
    public static final String STRINGS_STR = "commonj.sdo.Strings";
    
    public static final Type TIME = TYPE_HELPER.getType("commonj.sdo", "Time");
    public static final String TIME_STR = "commonj.sdo.Time";
    
    public static final Type URI = TYPE_HELPER.getType("commonj.sdo", "URI");
    public static final String URI_STR = "commonj.sdo.URI";
    
    public static final Type YEAR = TYPE_HELPER.getType("commonj.sdo", "Year");
    public static final String YEAR_STR = "commonj.sdo.Year";
    
    public static final Type YEARMONTH = TYPE_HELPER.getType("commonj.sdo", "YearMonth");
    public static final String YEARMONTH_STR = "commonj.sdo.YearMonth";
    
    public static final Type YEARMONTHDAY = TYPE_HELPER.getType("commonj.sdo", "YearMonthDay");
    public static final String YEARMONTHDAY_STR = "commonj.sdo.YearMonthDay";       
}
